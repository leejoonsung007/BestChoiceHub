...
function ajax_distanceComputing(position, c_place){
    ...
    $.ajax({
        type: 'POST',
        url: 'https://www.bestchoicehub.com/distance_computing/'+ position.lat + ','+ position.lng + '/' + city,
    ...
    $.each(selectedData, function(i,school){
        ...
        holder.append(
            '<div class="product-item col-xs-6 col-md-4">' +
                '<a target="_blank" href=\"https://www.bestchoicehub.com/school/'+ school.official_school_name+'/'+school.place_id+'\">' +
                    '<img style="height: 150px;"' +
                         'src="' + img_src + '" alt="sample school"/>' +
                '</a>'+

                '<h2 style="font-weight:bold"><a target="_blank" href=\"https://www.bestchoicehub.com/school/'+ school.official_school_name+'/'+school.place_id+'\">' +
