...
data = data[0:713]
data = data.fillna('')
school_addresses = data['Official School Name'] + ' ' + data['Address 1'] + ' ' + data['Address 2'] + ' ' + data[
    'Address 3'] + ' ' + data['Address 4']
...
reference = reference.rename(columns={0: 'Photo Reference 1', 1: 'Photo Reference 2', 2: 'Photo Reference 3', \
                                      ...
                                      16: 'Photo Reference 17', 17: 'Photo Reference 18', 18: 'Photo Reference 19',
                                      19: 'Photo Reference 20'})
